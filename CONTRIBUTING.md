# Contributing to flysystem-bunny-storage
...
Real-life tests require a live Bunny Storage zone:

```bash
BUNNY_API_KEY=xxx BUNNY_STORAGE_ZONE=yyy vendor/bin/phpunit --group integration
```

Without env vars, integration tests are skipped automatically.
